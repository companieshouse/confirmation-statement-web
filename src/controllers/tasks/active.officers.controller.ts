...
import { DIRECTOR_DETAILS_ERROR, RADIO_BUTTON_VALUE, SECTIONS } from "../../utils/constants";
...
export const get = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        const officerDetails: ActiveOfficerDetails = await getActiveOfficerDetailsData(
            session,
            transactionId,
            submissionId
        );
