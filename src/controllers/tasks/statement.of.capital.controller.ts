...
import { TASK_LIST_PATH, urlParams, WRONG_STATEMENT_OF_CAPITAL_PATH } from "../../types/page.urls";
...
import { SectionStatus, StatementOfCapital } from "@companieshouse/api-sdk-node/dist/services/confirmation-statement";
...
export const post = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        if (statementOfCapitalButtonValue === RADIO_BUTTON_VALUE.YES) {
            ...
            statementOfCapitalButtonValue === RADIO_BUTTON_VALUE.NO ||
            !sharesValidation ||
            !totalAmountUnpaidValidation
        ) {
