...
import { TASK_LIST_PATH, WRONG_REGISTER_LOCATIONS_PATH } from "../../types/page.urls";
...
export const get = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        const registerLocations: RegisterLocation[] = await getRegisterLocationData(
            session,
            transactionId,
            submissionId
        );
