...
import { CONFIRM_COMPANY_PATH, TASK_LIST_PATH, TRADING_STOP_PATH, urlParams } from "../types/page.urls";
...
const getConfirmCompanyUrl = (companyNumber: string): string =>
    `${CONFIRM_COMPANY_PATH}?companyNumber=${companyNumber}`;
