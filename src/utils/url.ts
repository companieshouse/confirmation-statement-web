...
const getUrlWithCompanyNumberTransactionIdAndSubmissionId = (
    url: string,
...
const getUrlToPath = (pathToPage: string, req: Request): string => {
    return getUrlWithCompanyNumberTransactionIdAndSubmissionId(
        pathToPage,
...
const setQueryParam = (url: string, paramName: URL_QUERY_PARAM, value: string) => url.replace(`{${paramName}}`, value);
