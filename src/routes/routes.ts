...
router.get(`${urls.LP_SIC_CODE_SUMMARY}/remove`, lpSicCodeSummaryRoute.removeSicCode);
router.post(`${urls.LP_SIC_CODE_SUMMARY}/add`, lpSicCodeSummaryRoute.addSicCode);