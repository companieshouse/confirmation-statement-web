...
export const CONFIRM_EMAIL_ADDRESS = ACTIVE_SUBMISSION_BASE + "confirm-email-address";
export const CONFIRM_EMAIL_PATH = CONFIRMATION_STATEMENT + CONFIRM_EMAIL_ADDRESS;
export const PROVIDE_EMAIL_ADDRESS = ACTIVE_SUBMISSION_BASE + "provide-email-address";
...
export const LP_CS_SUBMIT = LIMITED_PARTNERSHIP + "/confirmation-statement-submit"; 
export const LP_CS_SUBMIT_PATH = CONFIRMATION_STATEMENT + LP_CS_SUBMIT; 
