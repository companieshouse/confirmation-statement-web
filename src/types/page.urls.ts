...
export const CORPORATE_DIRECTORS = ACTIVE_SUBMISSION_BASE + "corporate-directors";
export const CORPORATE_DIRECTORS_PATH = CONFIRMATION_STATEMENT + CORPORATE_DIRECTORS;
export const CORPORATE_SECRETARIES = ACTIVE_SUBMISSION_BASE + "corporate-secretaries";
export const CORPORATE_SECRETARIES_PATH = CONFIRMATION_STATEMENT + CORPORATE_SECRETARIES;
...
export const NATURAL_PERSON_DIRECTORS = ACTIVE_SUBMISSION_BASE + "natural-person-directors";
export const NATURAL_PERSON_DIRECTORS_PATH = CONFIRMATION_STATEMENT + NATURAL_PERSON_DIRECTORS;
