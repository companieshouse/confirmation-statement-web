...
export const WRONG_RO =  ACTIVE_SUBMISSION_BASE + "incorrect-information/wrong-registered-office-address";
...
export const WRONG_OFFICER_DETAILS = ACTIVE_SUBMISSION_BASE + "wrong-officer-details";
export const WRONG_OFFICER_DETAILS_PATH = CONFIRMATION_STATEMENT + WRONG_OFFICER_DETAILS;
export const WRONG_PSC_DETAILS = ACTIVE_SUBMISSION_BASE + "incorrect-information/wrong-psc-statement";
export const WRONG_PSC_DETAILS_PATH = CONFIRMATION_STATEMENT + WRONG_PSC_DETAILS;
export const WRONG_PSC_STATEMENT = ACTIVE_SUBMISSION_BASE + "wrong-psc-statement";
