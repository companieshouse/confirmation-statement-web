...
export const ACTIVE_SUBMISSION_BASE =
...
export const COMPANY_LOOKUP =
    "/company-lookup/search?forward=/confirmation-statement/confirm-company?companyNumber={companyNumber}&backLink=/confirmation-statement/";
...
export const PSC_STATEMENT_PATH =
    CONFIRMATION_STATEMENT + PSC_STATEMENT + `?${URL_QUERY_PARAM.IS_PSC}={${URL_QUERY_PARAM.IS_PSC}}`;
...
export const INVALID_COMPANY_STATUS_PATH =
    CONFIRMATION_STATEMENT +
    INVALID_COMPANY_STATUS +
    `?${URL_QUERY_PARAM.COMPANY_NUM}={${URL_QUERY_PARAM.COMPANY_NUM}}`;
export const USE_PAPER = "/paper-filing";
export const USE_PAPER_PATH =
    CONFIRMATION_STATEMENT + USE_PAPER + `?${URL_QUERY_PARAM.COMPANY_NUM}={${URL_QUERY_PARAM.COMPANY_NUM}}`;
export const USE_WEBFILING = "/use-webfiling";
export const USE_WEBFILING_PATH =
    CONFIRMATION_STATEMENT + USE_WEBFILING + `?${URL_QUERY_PARAM.COMPANY_NUM}={${URL_QUERY_PARAM.COMPANY_NUM}}`;
export const NO_FILING_REQUIRED = "/no-filing-required";
export const NO_FILING_REQUIRED_PATH =
    CONFIRMATION_STATEMENT + NO_FILING_REQUIRED + `?${URL_QUERY_PARAM.COMPANY_NUM}={${URL_QUERY_PARAM.COMPANY_NUM}}`;
...
export const DIRS_NOT_VERIFIED = SEPARATOR + Templates.DIRS_NOT_VERIFIED;
export const DIRS_NOT_VERIFIED_PATH = CONFIRMATION_STATEMENT + DIRS_NOT_VERIFIED;
