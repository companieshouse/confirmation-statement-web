...
export const REGISTERED_EMAIL_ADDRESS_PATH = CONFIRMATION_STATEMENT + REGISTERED_EMAIL_ADDRESS;
export const CHECK_EMAIL_ADDRESS = ACTIVE_SUBMISSION_BASE + "confirm-email-address";
export const CHECK_EMAIL_PATH = CONFIRMATION_STATEMENT + CHECK_EMAIL_ADDRESS; //"/check-email-screen-coming-in-ecct-719"; // TODO change or remove this when ECCT-719 implemented
