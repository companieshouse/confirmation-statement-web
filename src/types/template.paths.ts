export enum Templates {
    ...
    LP_STOP_SCREEN = "limited-partners/components/stop-screen/stop-screen",
    LP_TRANSITIONAL_STOP_SCREEN = "limited-partners/components/stop-screen/transitional-stop-screen",
}
