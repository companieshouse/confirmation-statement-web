...
const URL = ACSP_LIMITED_PARTNERSHIP_PATH.replace(`:${urlParams.PARAM_COMPANY_NUMBER}`, COMPANY_NUMBER)
...
describe("start controller tests", () => {
    ...
    it("should redirect to before-you-file on form submission", async () => {
        ...
        expect(response.headers.location).toBe(
            "/confirmation-statement/company/12345678/transaction/trans-12345/submission/sub-12345/acsp/before-you-file?lang=en"
        );
    });
});
