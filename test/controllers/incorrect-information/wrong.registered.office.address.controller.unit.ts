...
const populatedWrongRegisteredOfficeAddressPath = urlUtils.getUrlWithCompanyNumberTransactionIdAndSubmissionId(
    WRONG_RO_PATH,
    COMPANY_NUMBER,
    TRANSACTION_ID,
    SUBMISSION_ID
...
const WRONG_ROA_PAGE_TITLE =
    "You need to update the registered office address - File a confirmation statement - GOV.UK";
...
describe("Wrong registered office address stop controller tests", () => {
    ...
    describe("test for the get function", () => {
        it("Should render the wrong registered office address stop page", async () => {
            ...
            const changeRoaUrl = urlUtils.getUrlWithCompanyNumberTransactionIdAndSubmissionId(
                CHANGE_ROA_PATH,
                COMPANY_NUMBER,
                TRANSACTION_ID,
                SUBMISSION_ID
