...
import { STATEMENT_OF_CAPITAL_PATH, WRONG_STATEMENT_OF_CAPITAL_PATH } from "../../../src/types/page.urls";
...
const populatedWrongStatementOfCapitalPath = urlUtils.getUrlWithCompanyNumberTransactionIdAndSubmissionId(
    ...
    describe("test for the get function", () => {
        it("Should render the wrong statement of capital stop page for when ONLY statement of capital validation has failed.", async () => {
            ...
            expect(response.text).toContain(
                "The company's share capital does not match the shares held by its shareholders."
            );
