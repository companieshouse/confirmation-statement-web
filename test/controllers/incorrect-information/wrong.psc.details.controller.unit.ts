...
import { ACTIVE_PSC_DETAILS_PATH, TASK_LIST_PATH, WRONG_PSC_DETAILS_PATH } from "../../../src/types/page.urls";
...
const populatedWrongPscDetailsPath = urlUtils.getUrlWithCompanyNumberTransactionIdAndSubmissionId(
