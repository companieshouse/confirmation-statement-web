...
import { REGISTER_LOCATIONS_PATH, TASK_LIST_PATH, WRONG_REGISTER_LOCATIONS_PATH } from "../../../src/types/page.urls";
...
const WRONG_REGISTER_PAGE_TITLE =
    "You need to update where the company records are kept - File a confirmation statement - GOV.UK";
...
const populatedWrongRegisterLocationsAddressPath = urlUtils.getUrlWithCompanyNumberTransactionIdAndSubmissionId(
