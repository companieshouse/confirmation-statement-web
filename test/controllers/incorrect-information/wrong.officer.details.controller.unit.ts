...
import { ACTIVE_OFFICERS_DETAILS_PATH, TASK_LIST_PATH, WRONG_OFFICER_DETAILS_PATH } from "../../../src/types/page.urls";
...
const populatedWrongOfficerDetailsPath = urlUtils.getUrlWithCompanyNumberTransactionIdAndSubmissionId(
