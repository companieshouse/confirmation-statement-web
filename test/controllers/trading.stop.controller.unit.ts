...
const TRADING_STOP_PAGE_TITLE =
    "You must use our WebFiling service to update the trading status - File a confirmation statement - GOV.UK";
    ...
    describe("test for the get function", () => {
        it("Should render the trading stop page", async () => {
            ...
            expect(response.text).toContain(
                "You must update this information by filing a confirmation statement through"
            );
        });
    });
});
