...
const RETURN_FROM_REA_URL = urlUtils.getUrlWithCompanyNumberTransactionIdAndSubmissionId(
    RETURN_FROM_REA_PATH,
    COMPANY_NUMBER,
    TRANSACTION_ID,
    SUBMISSION_ID
);
const CHECK_EMAIL_ADDRESS_URL = urlUtils.getUrlWithCompanyNumberTransactionIdAndSubmissionId(
