...
const CONFIRMATION_PAGE_HEADING =
    "Found. Redirecting to /confirmation-statement/company/12345678/transaction/66454/submission/435435/body/confirmation";
const REVIEW_PAGE_HEADING =
    "Found. Redirecting to /confirmation-statement/company/12345678/transaction/66454/submission/435435/body/review";
...
describe("Payment callback controller tests", () => {
    ...
    it("should show confirmation page for successful payment", async () => {
        ...
        const response = await request(app).get(successUrl);
    ...
    it("should show review page for declined payment", async () => {
        ...
        const response = await request(app).get(declinedUrl);
    ...
    it("should show review page for cancelled payment", async () => {
        ...
        const response = await request(app).get(cancelledUrl);
