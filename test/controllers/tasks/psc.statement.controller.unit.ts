...
const PSC_STATEMENT_URL_WITHOUT_QUERY_PARAMS = urlUtils.getUrlWithCompanyNumberTransactionIdAndSubmissionId(
    CONFIRMATION_STATEMENT + PSC_STATEMENT,
    COMPANY_NUMBER,
    TRANSACTION_ID,
    SUBMISSION_ID
);
const PSC_STATEMENT_URL_WITH_QUERY_PARAMS = urlUtils.getUrlWithCompanyNumberTransactionIdAndSubmissionId(
    PSC_STATEMENT_PATH,
    COMPANY_NUMBER,
    TRANSACTION_ID,
    SUBMISSION_ID
...
const WRONG_PSC_STATEMENT_URL = urlUtils.getUrlWithCompanyNumberTransactionIdAndSubmissionId(
    WRONG_PSC_STATEMENT_PATH,
    COMPANY_NUMBER,
    TRANSACTION_ID,
    SUBMISSION_ID
...
describe("PSC Statement controller tests", () => {
    ...
    describe("get tests", () => {
        it("Should show the psc statement page", async () => {
            const response = await request(app).get(PSC_STATEMENT_URL_WITHOUT_QUERY_PARAMS);
        ...
        it("Should back-link to the psc details page", async () => {
            const response = await request(app).get(pscStatementPathWithIsPscParam("true"));
        ...
        it("Should back-link to the task list page", async () => {
            const response = await request(app).get(pscStatementPathWithIsPscParam("false"));
