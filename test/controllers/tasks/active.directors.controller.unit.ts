...
import {
    mockActiveOfficerDetails,
    mockActiveOfficerDetailsFormatted,
    mockSecureActiveOfficerDetailsFormatted,
} from "../../mocks/active.director.details.mock";
...
describe("Active directors controller tests", () => {
    ...
    describe("get tests", () => {
        ...
        it("Should navigate to director's details page for secure director", async () => {
            ...
            mockFormatAddressForDisplay.mockReturnValueOnce(
                mockSecureActiveOfficerDetailsFormatted.serviceAddress.addressLine1
            );
            const response = await request(app).get(ACTIVE_OFFICER_DETAILS_URL);
