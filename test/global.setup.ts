export default () => {
    ...
    process.env.FEATURE_FLAG_SERVICE_WITHDRAWN_02102025 = "false";
    ...
    process.env.PIWIK_LPCS01_START_JOURNEY_GOAL_ID = "107";
    process.env.PIWIK_LPCS01_CONFIRMATION_GOAL_ID = "109";
    process.env.PIWIK_CS01_CONFIRMATION_GOAL_ID = "110";
