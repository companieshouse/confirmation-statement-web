...
const SUBMISSION_ID_INVALID =
    "8686876876ds6fds6fsd87f686454395743895747543895793485798437598437598437598437598375945435435543";
...
describe("Transaction ID validation middleware tests", () => {
    ...
    it("Should stop invalid transaction id", async () => {
        ...
        const urlWithInvalidTransactionId = urlUtils.getUrlWithCompanyNumberTransactionIdAndSubmissionId(
            TRADING_STATUS_PATH,
            COMPANY_NUMBER,
