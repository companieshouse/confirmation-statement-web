...
import { isLimitedPartnershipFeatureFlagEnabled, isCompanyTypePermittedForLimitedPartnerships } from "../../src/utils/feature.flag";
...
describe("start Integrated Limited Partnership Journey validation middleware tests", () => {
  ...
  it("validateIntegratedJourney pass with company type in FEATURE_FLAG_LP_INTEGRATED_JOURNEY_PERMITTED_TYPES, " +
    "Eligibility Checks OK, Today after FEATURE_FLAG_LP_REFORM_DATE, logged in as ACSP", async () => {
