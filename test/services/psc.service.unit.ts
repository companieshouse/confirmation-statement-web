...
const mockGetPersonsOfSignificantControl = ConfirmationStatementService.prototype
    .getPersonsOfSignificantControl as jest.Mock;
...
describe("Test psc service", () => {
    ...
    describe("getPscs tests", () => {
        ...
        it("should throw error when http error code is returned", async () => {
            ...
            const expectedMessage =
                "Error retrieving pscs from confirmation-statement-api " + JSON.stringify(errorResponse);
    ...
    describe("getPscStatements tests", () => {
        ...
        it("should throw error when http error code is returned for statement request", async () => {
            ...
            const expectedMessage =
                "Error retrieving psc statement from psc statement api " + JSON.stringify(errorResponse);
            let actualMessage: any;
            try {
    ...
    describe("getMostRecentActivePscStatement tests", () => {
        it("should return the most recent active psc statement", async () => {
            ...
            mockGetCompanyPscStatements.mockResolvedValueOnce(resource);
            const pscStatement: CompanyPersonWithSignificantControlStatement = await getMostRecentActivePscStatement(
                session,
                companyNumber
            );
