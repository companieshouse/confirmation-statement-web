...
import {
    getRegisteredEmailAddress,
    doesCompanyHaveEmailAddress,
} from "../../src/services/registered.email.address.service";
...
const validEmailResponse: Resource<RegisteredEmailAddressResponse> = {
    httpStatusCode: 200,
    resource: { registered_email_address: "test@email.org" },
};
const emailNotFoundResponse: ApiErrorResponse = {
    httpStatusCode: 404,
    errors: [{ error: "Registered Email Address not found" }],
};
