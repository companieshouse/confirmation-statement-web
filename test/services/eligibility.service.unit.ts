...
const mockGetEligibility = ConfirmationStatementService.prototype.getEligibility as jest.Mock;
...
describe("Test eligibility checks", () => {
    ...
    const errorMessageTemplate =
        'Error retrieving eligibility data from confirmation-statment api: {"httpStatusCode":HTTP_STATUS_CODE}';
    ...
    test.each([400, 401, 404, 500])(
        "Should throw an error if eligibility check returns error code %s",
        async errorStatus => {
