...
import {
    ...
    mockConfirmationStatementSubmissionAllConfirmed,
    mockConfirmationStatementSubmissionMixedStatuses,
...
const mockGetUrlWithCompanyNumberTransactionIdAndSubmissionId =
    urlUtils.getUrlWithCompanyNumberTransactionIdAndSubmissionId as jest.Mock;
...
describe("Task List Service tests", () => {
    ...
    describe("initTaskList tests", () => {
        it("Should return a populated task list", () => {
            ...
            expect(mockGetUrlWithCompanyNumberTransactionIdAndSubmissionId.mock.calls[1][0]).toBe(
                PEOPLE_WITH_SIGNIFICANT_CONTROL_PATH
            );
            ...
            expect(mockGetUrlWithCompanyNumberTransactionIdAndSubmissionId.mock.calls[2][0]).toBe(
                REGISTER_LOCATIONS_PATH
            );
            ...
            expect(mockGetUrlWithCompanyNumberTransactionIdAndSubmissionId.mock.calls[3][0]).toBe(
                CHECK_EMAIL_ADDRESS_PATH
            );
            ...
            expect(mockGetUrlWithCompanyNumberTransactionIdAndSubmissionId.mock.calls[4][0]).toBe(
                REGISTERED_OFFICE_ADDRESS_PATH
            );
            ...
            expect(mockGetUrlWithCompanyNumberTransactionIdAndSubmissionId.mock.calls[7][0]).toBe(
                STATEMENT_OF_CAPITAL_PATH
            );
