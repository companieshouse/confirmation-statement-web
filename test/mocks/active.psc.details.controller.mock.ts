...
export const mockPscList: any[] = [
    {
        ...
        naturesOfControl: ["75% or more of shares held as a person", "Ownership of voting rights - more than 75%"],
    },
    {
        ...
        naturesOfControl: ["50% or more of shares held as a person", "Ownership of voting rights - more than 50%"],
    },
    {
        ...
        naturesOfControl: ["Ownership of voting rights - more than 75%"],
    },
];
...
export const mockMultiPscList: any[] = [
    ...
    },
    {
        ...
        naturesOfControl: ["40% or more of shares held as a person", "Ownership of voting rights - more than 40%"],
    },
    {
        appointmentType: appointmentTypes.LEGAL_PERSON_PSC,
        nameElements: mockRleNameElements,
    ...
    },
    {
        ...
        lawGoverned: "UK",
        legalForm: "Charity - Unincorporated Association",
        naturesOfControl: ["Ownership of voting rights - more than 25%"],
    },
];
