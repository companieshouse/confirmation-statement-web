...
const mockCompanyNumberQueryParameterValidationMiddleware =
    companyNumberQueryParameterValidationMiddleware as jest.Mock;

// tell the mock what to return
mockCompanyNumberQueryParameterValidationMiddleware.mockImplementation(
